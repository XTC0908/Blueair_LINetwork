...
{
	SpiOpenFlags	oFlags=SPI_OPEN_MODE16 |SPI_OPEN_MSTEN;// SPI open mode, CS not driven |SPI_OPEN_MSSEN
//|SPI_OPEN_CKE_REV

	SpiChnOpen(chn, oFlags, 128);	// divide fpb by 4, configure the I/O ports. 
	//
}


void SPITankInit(void)
{
SpiInitDevice(3, 1, 1, 1);
SpiChnChangeMode(3, 1, 1, 1);	
SpiChnPutC(3, 0x2000003);
//
//SpiChnChangeMode(3, 1, 1, 1);	
//SpiChnPutC(3, 0x2000000);
//
//SpiChnChangeMode(3, 1, 1, 1);	
//SpiChnPutC(3, 0x2000000);
//
