/********************************************************************
 ...
 Hardware:		The code is natively intended to be used on the following
 				hardware platforms: PICDEMÖ FS USB Demo Board, 
 ...
 (the ôCompanyö) for its PIC« Microcontroller is intended and
...
ROM struct{BYTE report[HID_RPT01_SIZE];}hid_rpt01={{
  ...
  0x46,0xFF,0xFF,  //  PHYSICAL_MAXIMUM(255)
  0x09,0x30,        //  USAGE(X)
  0x09,0x31,        //  USAGE(Y)
  0x09,0x32,        //  USAGE(Z)
  0x09,0x33,        //  USAGE(RX)
